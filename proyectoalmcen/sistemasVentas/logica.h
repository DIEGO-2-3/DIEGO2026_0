...
void registrarMovimiento(bool entrada) {
    ...
    cout << "Fecha (dia mes anio): "; cin >> m.fecha.d >> m.fecha.m >> m.fecha.a;
    ...
    do {
        ...
        switch (op) {
            ...
            case 3: 
                ...
                if(i!=-1) { cout << "Nuevo Precio: "; cin >> inventario[i].precio; cout << "Nuevo Stock: "; cin >> inventario[i].stock; guardarInventario(); mensajeExito("Actualizado"); }
                else mensajeError("No encontrado"); break;
            case 4:
                cout << "Producto: "; cin >> n; i = buscarProducto(n);
                if(i!=-1) { cout << "Nuevo Stock Minimo: "; cin >> inventario[i].stockMinimo; guardarInventario(); mensajeExito("Configurado"); }
                else mensajeError("No encontrado"); break;
        }
    } while (op != 5);
}
